...
class MyDataloader:
    ...
    def _setting(self, data:pd.DataFrame) -> pd.DataFrame:
        ...
        data["Street"] = data["Street"].map({"Grvl":2,
                                                       "Pave":1})
        data["Alley"] = data["Alley"].map({"Grvl":2,
                                                     "Pave":1})
        ...
        data["BsmtFinType1"] = data["BsmtFinType2"].map({
                                                             "GLQ":6,
                                                             "ALQ":5,
                                                             "BLQ":4,
                                                             "Rec":3,
        ...
        data["HeatingQC"] = data["HeatingQC"].map({"Ex":5,
                                                             ...
                                                             "Fa":2,
                                                             "Po":1})
        data["CentralAir"] = data["CentralAir"].map({"Y":1,
                                                               "N":0})
        data["KitchenQual"] = data["KitchenQual"].map({"Ex":5,
                                                             ...
                                                             "Fa":2,
                                                             "Po":1})
        data["FireplaceQu"] = data["FireplaceQu"].map({"Ex":5,
                                                             "Gd":4,
                                                             "TA":3,
                                                             "Fa":2,
                                                             "Po":1})
        ...
        data["PavedDrive"] = data["PavedDrive"].map({"Y":2,
                                                               "P":1,
                                                               "N":0})
        data["PoolQC"] = data["PoolQC"].map({"Ex":4,
                                                       "Gd":3,
                                                       "TA":2,
                                                       "Fa":1})
        ...
        data = pd.get_dummies(data, columns=info.one_hot_encoding, dtype=int)
    ...
    def accumulated_local_effects_data(self, feature:list, n:int):
        result_data = [[], [], [feature]]
