...
class Engine:
    ...
    def fit(self):
        ...
        self.x_train, self.y_train = self.train_data.drop(info.target, axis=1), self.train_data[info.target]
        self.x_test, self.y_test = self.test_data.drop(info.target, axis=1), self.test_data[info.target]
