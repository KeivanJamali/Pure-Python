...
class Extract_template():
    ...
    def generate(self, output_file_dir:str, want_time_line:bool=False) -> None:
        code_lines = []
        max_retries = 15
        ...
        self._save_to(output_file_dir, output_code)
    
    def _save_to(self, output_file_dir, output_file):
        basename = os.path.basename(self.file_path)
        output_file_name = os.path.join(output_file_dir, f"template_{basename[:-3]}py")
