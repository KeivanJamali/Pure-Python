file_path = r'D:/All Python/Pure-Python\bridge.dwg'
...
entity = acad.model.AddText('1311.05', APoint(65.96961459937938, 133.01573766214926, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('-1.25', APoint(130.04656825892198, 76.21478786357738, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('-0.45', APoint(128.3737502290519, 91.98447663885179, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('760588.25', APoint(128.3737502290519, 113.72666199353296, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('-0.91', APoint(20.77792512834594, 75.177517725283, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('-0.11', APoint(22.450743158216028, 90.9472065005574, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1321.85', APoint(22.450743158216028, 112.68939185523857, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('=correct', APoint(95.19832279330512, 7.3336372942450225, 0.0), 1.95)
entity.Color = 7
...
entity = acad.model.AddText('nan', APoint(90.16912161954542, 16.748138742348033, 0.0), 2.0)
entity.Color = 7
...
entity = acad.model.AddText('نقشه همسان آبرو تک دهانه', APoint(301.76777422148143, 17.964747298063685, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('همسطح و زیرخاکی', APoint(301.76777422148143, 14.500738236698902, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('عمود بر محور راه', APoint(301.76777422148143, 11.166459578209922, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('وزارت راه و شهرسازی - مرکز تحقیقات راه مسکن و شهرسازی', APoint(349.22695857402596, 14.572511580924584, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('نقشه های همسان آبروهای راه تا دهانه 10 متر نشریه شماره 1-292', APoint(348.9464961603944, 7.8906915393545205, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText(': توضیحات', APoint(73.108729720464, 21.843339434359564, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(21.706971832195904, 12.854608686151096, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(21.64362394905129, 9.013810570597686, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('correct', APoint(21.919262370884553, 19.195197129738062, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(21.717077853479623, 16.522421907421972, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText(': شماره نقشه همسان', APoint(320.10515583988035, 6.591915817642985, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('292-SB-1S-1/3', APoint(300.0213153431714, 6.479800353880023, 0.0), 1.7)
entity.Color = 1
...
entity = acad.model.AddText('سازمان مدیریت و برنامه ریزی کشور - امور نظام فنی اجرایی', APoint(349.14922402933644, 20.926001891046212, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('0.3', APoint(211.87380717053222, 164.40189832989302, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('?????????????', APoint(191.3387724121702, 171.59447630981737, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('1.0', APoint(205.08959110291212, 150.2229991960395, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('A=5.8', APoint(53.9686315448064, 83.01599936022706, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('B=5.8', APoint(97.18291725909143, 83.01599936022706, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('12.0 %', APoint(220.16600460045447, 198.96823443682956, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('Yazd', APoint(73.66342937093555, 202.50501123465074, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('DOWN', APoint(129.21399861891655, 247.79745180699797, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('TABAS', APoint(72.18681963028166, 283.129813015315, 0.0), 3.0)
entity.Color = 5
...
entity = acad.model.AddText('130910.0 %', APoint(83.20649667367229, 127.24415835969967, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('2.0 %', APoint(66.48239742618875, 127.40024669234526, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('nan', APoint(138.9004990430826, 16.310675829568027, 0.0), 4.0)
entity.Color = 1

entity = acad.model.AddText('nan', APoint(133.21161950275015, 6.930427531728016, 0.0), 4.0)
entity.Color = 1

entity = acad.model.AddText('i-163', APoint(172.61304054557147, 16.423246599519985, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('nan', APoint(172.13668673507195, 7.6274657833401225, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('nan', APoint(214.14010818091788, 18.81413230542546, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(214.22244369193868, 7.193443505081677, 0.0), 1.5)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(256.76944855299257, 7.951570707954943, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('nan', APoint(256.9134080336812, 17.50061594009617, 0.0), 1.7)
entity.Color = 7
