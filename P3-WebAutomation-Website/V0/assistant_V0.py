...
# llama3 = "QuantFactory/Meta-Llama-3-8B-Instruct-GGUF/Meta-Llama-3-8B-Instruct.Q4_0.gguf"
llama2 = "TheBloke/Llama-2-7B-Chat-GGUF/llama-2-7b-chat.Q4_0.gguf"
...
def send_to_assistant(txt):
    return generate_chat_completion(f"{context}\n\nUser: {txt}\n\nAssistant: ",
                                    max_tokens=1000,
                                    temperature=0.7,
                                    top_p=0.9,
                                    n=1,
