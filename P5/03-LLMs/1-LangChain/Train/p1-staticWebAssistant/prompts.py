...
prompt_2 = ChatPromptTemplate([("system", """1. Rewrite the question so it explicitly refers to the subject mentioned in [data] (e.g., use the person's name instead of pronouns).
                               ...
                               validate_template=True)
prompt_3 = ChatPromptTemplate([("system", """You sould check if data is related to the question or not.\n
                               ...
                               validate_template=True)
prompt_4 = ChatPromptTemplate([("system", """Your name is KPG. A person with a strong personality and charisma.
                               ...
                               validate_template=True)
prompt_5 = ChatPromptTemplate([("system", "You are an expert English translator. You can translate English to any language."),
