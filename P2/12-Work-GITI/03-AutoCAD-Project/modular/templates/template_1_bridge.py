...
entity = acad.model.AddText('n', APoint(108.37515465262004, 122.8148757869692, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('8*2', APoint(336.02578237597845, 241.46776131919867, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('1136.6', APoint(369.2536430399505, 241.4947039320718, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('18809.9', APoint(377.12219067769274, 241.3258687642022, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.37074024143385, 241.3553104647698, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(394.02901997446315, 241.34525848758338, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('55*2', APoint(335.2943384735654, 235.14069921956778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.37074024143385, 235.3553104647698, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('2', APoint(368.64769595222333, 235.4947039320718, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('36.24', APoint(376.29734907020793, 235.4352017132442, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(392.87459199746536, 235.40614848471895, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('3*2', APoint(336.04702018620264, 229.46776131919867, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('2', APoint(368.64769595222333, 229.4947039320718, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('41.38', APoint(376.9540326294764, 229.32586876420208, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.37074024143385, 229.3553104647698, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(402.91105512762806, 229.34525848758307, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('9*2', APoint(335.5393902606993, 223.66256247382648, 0.0), 1.35)
entity.Color = 1
...
entity = acad.model.AddText('1', APoint(368.64769595222333, 223.4947039320718, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('17.71', APoint(376.4983777920961, 223.38275789371906, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.37074024143385, 223.3553104647698, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(402.87317118136616, 223.34525848758307, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('7.7', APoint(389.57853430496925, 211.4902574983033, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('20.4', APoint(401.3121729414843, 204.65862849603846, 0.0), 1.875)
entity.Color = 1
...
entity = acad.model.AddText('3.0', APoint(368.8041756690318, 271.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('49.65', APoint(377.0541756690318, 271.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('2.0', APoint(385.3041756690318, 271.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('33.06', APoint(393.5541756690318, 271.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('3.0', APoint(368.8041756690318, 265.450604270878, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('49.65', APoint(377.0541756690318, 265.450604270878, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('2.0', APoint(385.3041756690318, 265.450604270878, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('33.06', APoint(393.5541756690318, 265.450604270878, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1584.6', APoint(368.8041756690318, 259.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('26224.3', APoint(377.0541756690318, 259.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1.2', APoint(385.3041756690318, 259.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('20.0', APoint(393.5541756690318, 259.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('2.8', APoint(368.8041756690318, 253.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('46.34', APoint(377.0541756690318, 253.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.3041756690318, 253.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(393.5541756690318, 253.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1136.6', APoint(368.8041756690318, 247.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('18809.9', APoint(377.0541756690318, 247.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.6', APoint(385.3041756690318, 247.45060427087788, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('10.2', APoint(393.5541756690318, 247.45060427087788, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('147.3', APoint(381.4255070372601, 196.76495762539972, 0.0), 1.875)
entity.Color = 1
...
entity = acad.model.AddText('-', APoint(335.5393902606993, 217.66256247382648, 0.0), 1.35)
entity.Color = 1

entity = acad.model.AddText('3', APoint(368.64769595222333, 217.4947039320718, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('49.65', APoint(376.4983777920961, 217.38275789371906, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('-', APoint(385.71842523953546, 217.3553104647698, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('-', APoint(393.96842523953273, 217.3553104647698, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('=0', APoint(95.19832279330512, 7.3336372942450225, 0.0), 1.95)
entity.Color = 7
...
entity = acad.model.AddText('60 cm', APoint(90.16912161954542, 16.748138742348033, 0.0), 2.0)
entity.Color = 7
...
entity = acad.model.AddText('نقشه همسان آبرو تک دهانه', APoint(305.8329314423099, 17.964747298063685, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('همسطح و زیرخاکی', APoint(310.47652519758776, 14.500738236698908, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('عمود بر محور راه', APoint(312.1837299108238, 11.166459578209924, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('ابعاد  کوله و دیوارها و جزئیات میلگردگذاری طبق نقشه شماره', APoint(21.706971832195904, 12.854608686151096, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('.انختاب شوند', APoint(42.72395407127624, 8.767382052529115, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('تمام موارد مندرج در بخش توضیحات کلی و عمومی به طور کامل', APoint(21.919262370884553, 19.195197129738062, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('.شود', APoint(77.32766942873695, 16.11358731796315, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('292-SB-SS', APoint(71.17118178257624, 9.267713204698566, 0.0), 1.5)
entity.Color = 7

entity = acad.model.AddText('و', APoint(68.41137559176968, 8.919781099026864, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('292-SB-D', APoint(57.3013885318087, 9.180494525620134, 0.0), 1.5)
entity.Color = 7

entity = acad.model.AddText(': شماره نقشه همسان', APoint(320.10515583988035, 6.591915817642985, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('292-SB-1S-1/3', APoint(297.17156399581563, 6.479800353880023, 0.0), 1.7)
entity.Color = 1
...
entity = acad.model.AddText('i-167', APoint(256.9134080336812, 17.50061594009617, 0.0), 1.3)
entity.Color = 7
