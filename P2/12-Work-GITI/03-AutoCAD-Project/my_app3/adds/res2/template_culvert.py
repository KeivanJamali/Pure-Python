file_path = r'D:/All Python/Pure-Python/P2/12-Work-GITI/03-AutoCAD-Project/my_app3/adds/res2\Culvert-Final.dwg'
file_to_open = r'D:/All Python/Pure-Python/P2/12-Work-GITI/03-AutoCAD-Project/my_app3/adds/res2\Culvert.dwg'
...
entity = acad.model.AddLine(APoint(95.82103977742327, 217.04210557548978, 0.0), APoint(93.00310997175711, 215.6698363892238, 0.0))
entity.Color = 1
try:
    entity.LineType = 'Continuous'
    entity.LineTypeScale = 1.0
...
entity = acad.model.AddLine(APoint(95.85902003038518, 215.75404698929037, 0.0), APoint(92.96512971879474, 216.957894975423, 0.0))
entity.Color = 1
try:
    entity.LineType = 'Continuous'
    entity.LineTypeScale = 1.0
...
entity = acad.model.AddArc(APoint(92.98411984527411, 216.3138656823234, 0.0), 0.6443092078142245, 1.600274218406479, 4.741866871997636)
entity.Color = 1
...
entity = acad.model.AddText('37.14', APoint(65.96961459937938, 125.65028739040292, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('33.67', APoint(130.04656825892198, 76.21478786357733, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.47', APoint(128.3737502290519, 91.98447663885179, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('35.97', APoint(128.3737502290519, 113.72666199353301, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('34.25', APoint(20.777925128345487, 75.17751772528294, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('35.05', APoint(22.450743158216483, 90.9472065005574, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('36.47', APoint(22.450743158216483, 112.68939185523857, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('18', APoint(329.10399982919625, 271.45060427087776, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('22', APoint(341.6226798152993, 271.1663370082133, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('22.0', APoint(346.029128755501, 272.47700168282347, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('20', APoint(349.8750125165552, 271.8083044686093, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('209.0', APoint(355.75054927572455, 270.97920294104927, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('22', APoint(363.4916343102632, 270.88542531145265, 0.0), 1.3125)
entity.Color = 1
...
entity = acad.model.AddText('22', APoint(363.2255451534247, 265.34985407175657, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('209.0', APoint(359.3396217533664, 266.66051874636673, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('20', APoint(355.065887391891, 265.9918215321527, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('27.0', APoint(349.8057012331419, 265.16272000459264, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('22', APoint(341.65159854783633, 265.0689423749959, 0.0), 1.3125)
entity.Color = 1
...
entity = acad.model.AddText('20.7', APoint(352.49400297421016, 260.1026205989905, 0.0), 1.3125)
entity.Color = 1
...
entity = acad.model.AddText('250', APoint(352.82956682788335, 254.3837620275766, 0.0), 1.3125)
entity.Color = 1
...
entity = acad.model.AddText('20.2', APoint(352.49400297421016, 248.1026205989904, 0.0), 1.3125)
entity.Color = 1
...
entity = acad.model.AddText('20.2', APoint(352.49400297421016, 242.1026205989904, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('20.2', APoint(368.80417566903276, 241.49470393207167, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('323.68', APoint(377.3424045167534, 241.3258687642021, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.617', APoint(385.5924045167534, 241.3553104647697, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('199.56', APoint(393.8424045167534, 241.3452584875833, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('64*2', APoint(335.7891998808309, 235.1406992195677, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('45', APoint(348.3975740828764, 234.76630375089647, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('45', APoint(354.2954519055302, 235.67910068220698, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('17', APoint(348.2430401421325, 236.9312482083771, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('2.2', APoint(369.10725454831226, 235.4947039320717, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('280.32', APoint(377.3424045167534, 235.4352017132441, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('172.83', APoint(393.8424045167534, 235.40614848471887, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('2.5', APoint(352.49400297421016, 230.1026205989904, 0.0), 1.3125)
entity.Color = 1

entity = acad.model.AddText('2.5', APoint(369.10725454831226, 229.4947039320717, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('15.0', APoint(377.3424045167534, 229.325868764202, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.617', APoint(385.5924045167534, 229.3553104647697, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('9.25', APoint(402.0924045167519, 229.35531046476967, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('9*2', APoint(335.7891998808309, 223.66256247382637, 0.0), 1.35)
entity.Color = 1
...
entity = acad.model.AddText('19.26', APoint(377.3424045167534, 223.38275789371897, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.617', APoint(385.5924045167534, 223.3553104647697, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('11.87', APoint(402.0924045167519, 223.34525848758298, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('88.6', APoint(389.57853430497016, 211.4902574983032, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('21.1', APoint(401.3121729414852, 204.65862849603838, 0.0), 1.875)
entity.Color = 1

entity = acad.model.AddText('18', APoint(329.05438256718116, 265.4506042708779, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('8', APoint(335.80438256718026, 247.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('69', APoint(335.80438256718026, 253.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('11', APoint(335.80438256718026, 259.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('69', APoint(335.80438256718026, 265.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('69', APoint(335.7891998808309, 271.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('3.0', APoint(369.1072545483123, 271.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('207.0', APoint(377.3424045167534, 271.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1.998', APoint(385.5924045167534, 271.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('413.5', APoint(393.8424045167534, 271.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('3.0', APoint(369.10725454831226, 265.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('207.0', APoint(377.3424045167534, 265.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1.998', APoint(385.5924045167534, 265.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('413.5', APoint(393.8424045167534, 265.4506042708779, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('20.7', APoint(369.10725454831226, 259.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('227.46', APoint(377.3424045167534, 259.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('1.208', APoint(385.5924045167534, 259.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('274.87', APoint(393.8424045167534, 259.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('2.8', APoint(369.10725454831226, 253.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('193.2', APoint(377.3424045167534, 253.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.617', APoint(385.5924045167534, 253.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('119.12', APoint(393.8424045167534, 253.45060427087776, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('20.2', APoint(369.10725454831226, 247.45060427087782, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('161.84', APoint(377.3424045167534, 247.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('0.617', APoint(385.5924045167534, 247.4506042708778, 0.0), 1.5)
entity.Color = 1

entity = acad.model.AddText('99.78', APoint(393.8424045167534, 247.4506042708778, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('1714.3', APoint(381.425507037261, 196.76495762539963, 0.0), 1.875)
entity.Color = 1
...
entity = acad.model.AddText('5.1', APoint(217.7809723917303, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.67', APoint(259.67738365508967, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(305.8050273355434, 53.585350706841155, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('3.5', APoint(217.7809723917303, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.67', APoint(259.67738365508967, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(305.8050273355434, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('3.7', APoint(217.7809723917303, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.0', APoint(259.67738365508967, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('--', APoint(305.8050273355434, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.35', APoint(217.7809723917303, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.0', APoint(259.67738365508967, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('--', APoint(305.8050273355434, 37.499530380970896, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('33.82', APoint(277.76420268013726, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.78', APoint(277.76420268013726, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.25', APoint(277.76420268013726, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.25', APoint(277.76420268013726, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('--', APoint(292.6268319940823, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('--', APoint(292.6268319940823, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.14', APoint(292.6268319940823, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.17', APoint(292.6268319940823, 37.499530380970896, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('0.8', APoint(319.33309069892084, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(319.33309069892084, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(319.33309069892084, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(319.33309069892084, 37.499530380970896, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('0.85', APoint(333.04333757537506, 53.585350706841155, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1.64', APoint(345.9174863036028, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.64', APoint(345.9174863036028, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.85', APoint(345.9174863036028, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.85', APoint(345.9174863036028, 37.499530380970896, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('2.05', APoint(229.79158451580906, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('2.05', APoint(229.79158451580906, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('3.7', APoint(229.79158451580906, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('2.7', APoint(229.79158451580906, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.97', APoint(242.87490078214387, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.97', APoint(242.87490078214387, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.0', APoint(242.87490078214387, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.0', APoint(242.87490078214387, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.19', APoint(359.69367961878334, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.19', APoint(359.69367961878334, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.58', APoint(359.69367961878334, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.58', APoint(359.69367961878334, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.68', APoint(372.3459401257537, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.51', APoint(386.1801513357973, 53.585350706841155, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.51', APoint(386.1801513357973, 48.22341059821781, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.68', APoint(386.1801513357973, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.68', APoint(386.1801513357973, 37.499530380970896, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.35', APoint(398.8266390026288, 53.585350706841155, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('0.35', APoint(398.8266390026288, 48.22341059821758, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.5', APoint(398.8266390026288, 42.86147048959424, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.5', APoint(398.8266390026288, 37.49953038097078, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.68', APoint(372.3459401257537, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.16', APoint(372.3459401257537, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.16', APoint(372.3459401257537, 37.49953038097101, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.85', APoint(333.04333757537506, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(333.04333757537506, 42.86147048959447, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(333.04333757537506, 37.49953038097101, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('.', APoint(95.79192815546584, 215.9609206573558, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1.73', APoint(223.97945180957362, 177.61240280644563, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('0.25', APoint(220.5718274798951, 190.47483345267534, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('1.76', APoint(191.33877241217047, 171.59447630981737, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('A=6.87', APoint(53.9686315448064, 83.01599936022694, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('B=12.24', APoint(97.18291725909211, 83.01599936022694, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('L=19.11', APoint(75.67637378933908, 74.16976331948865, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('-3 %', APoint(83.28338523671505, 119.52914341798692, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('3 %', APoint(66.55928598923151, 119.68523175063251, 0.0), 1.7249999999999992)
entity.Color = 1

entity = acad.model.AddText('UP', APoint(20.84343490445349, 96.67850435676787, 0.0), 3.0)
entity.Color = 5
...
entity = acad.model.AddText('300', APoint(114.80941006904345, 118.38311975069689, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1', APoint(117.81793375059328, 115.06301067296943, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('DOWN', APoint(126.81206858877977, 97.02109307313238, 0.0), 3.0)
entity.Color = 5
...
entity = acad.model.AddText('-1 %', APoint(222.1468235795992, 198.92929040968443, 0.0), 1.7249999999999992)
entity.Color = 1

entity = acad.model.AddText('UP', APoint(22.73272254799485, 185.96785877586683, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('i-094', APoint(81.97557694699285, 168.26555371369759, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('DOWN', APoint(148.63549219696006, 239.7056894632342, 0.0), 3.0)
entity.Color = 5
