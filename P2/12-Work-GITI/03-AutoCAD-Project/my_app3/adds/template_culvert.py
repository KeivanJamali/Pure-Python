file_path = r'D:/All Python/Pure-Python/P2/12-Work-GITI/03-AutoCAD-Project/my_app3/adds\Culvert-Final.dwg'
file_to_open = r'D:/All Python/Pure-Python/P2/12-Work-GITI/03-AutoCAD-Project/my_app3/adds\Culvert.dwg'
...
entity = acad.model.AddText('33.86', APoint(130.04656825892198, 76.21478786357738, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.66', APoint(128.3737502290519, 91.98447663885179, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('100', APoint(352.49400297420925, 260.1026205989906, 0.0), 1.3125)
...
entity = acad.model.AddText('100', APoint(352.49400297420925, 248.10262059899048, 0.0), 1.3125)
...
entity = acad.model.AddText('100', APoint(352.49400297420925, 242.10262059899048, 0.0), 1.3125)
...
entity = acad.model.AddText('2', APoint(369.10725454831135, 235.4947039320718, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('250', APoint(352.49400297420925, 230.10262059899048, 0.0), 1.3125)


entity = acad.model.AddText('2', APoint(369.10725454831135, 229.4947039320718, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('1', APoint(369.10725454831135, 223.4947039320718, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('3.5', APoint(217.78097239173076, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.22', APoint(259.6773836550901, 53.58535070684127, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('3.5', APoint(217.78097239173076, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.22', APoint(259.6773836550901, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.8', APoint(305.80502733554385, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('2.05', APoint(217.78097239173076, 42.86147048959458, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.86', APoint(259.6773836550901, 42.86147048959458, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('33.86', APoint(259.6773836550901, 37.49953038097101, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('34.33', APoint(277.7642026801377, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('34.33', APoint(277.7642026801377, 48.223410598217924, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.76', APoint(277.7642026801377, 42.86147048959458, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('33.76', APoint(277.7642026801377, 37.49953038097101, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1.53', APoint(345.91748630360325, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.53', APoint(345.91748630360325, 48.223410598217924, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1.91', APoint(229.79158451580952, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.91', APoint(229.79158451580952, 48.223410598217924, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('1.13', APoint(359.6936796187838, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1.13', APoint(359.6936796187838, 48.223410598217924, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('0.49', APoint(386.18015133579775, 53.58535070684127, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('0.49', APoint(386.18015133579775, 48.223410598217924, 0.0), 2.0)
entity.Color = 1
...
entity = acad.model.AddText('=23', APoint(95.19832279330512, 7.3336372942450225, 0.0), 1.95)
entity.Color = 7
...
entity = acad.model.AddText('22', APoint(90.16912161954542, 16.748138742348033, 0.0), 2.0)
entity.Color = 7
...
entity = acad.model.AddText('map1', APoint(301.76777422148143, 17.964747298063685, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('map2', APoint(301.76777422148143, 14.500738236698902, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('map3', APoint(301.76777422148143, 11.166459578209922, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('data2', APoint(349.22695857402596, 14.572511580924584, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('data3', APoint(348.9464961603944, 7.8906915393545205, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('123456789', APoint(300.0213153431714, 6.479800353880023, 0.0), 1.7)
entity.Color = 1
...
entity = acad.model.AddText('data1', APoint(349.14922402933644, 20.926001891046212, 0.0), 1.7)
entity.Color = 7
...
entity = acad.model.AddText('1.73', APoint(191.3387724121702, 171.59447630981737, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('Hs=1.73s', APoint(227.6412594882507, 191.61121280391768, 0.0), 1.5)
entity.Color = 1
...
entity = acad.model.AddText('-1.0 %', APoint(220.16600460045447, 198.96823443682956, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('???', APoint(73.66342937093555, 202.50501123465074, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('DOWN', APoint(129.21399861891655, 247.79745180699797, 0.0), 3.0)
entity.Color = 5

entity = acad.model.AddText('???', APoint(72.18681963028166, 283.129813015315, 0.0), 3.0)
entity.Color = 5
...
entity = acad.model.AddText('-3.0 %', APoint(83.20649667367229, 127.24415835969967, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('3.0 %', APoint(66.48239742618875, 127.40024669234526, 0.0), 1.7249999999999992)
entity.Color = 1
...
entity = acad.model.AddText('20', APoint(138.9004990430826, 16.310675829568027, 0.0), 4.0)
entity.Color = 1

entity = acad.model.AddText('21', APoint(133.21161950275015, 6.930427531728016, 0.0), 4.0)
entity.Color = 1

entity = acad.model.AddText('i-163', APoint(172.61304054557147, 16.423246599519985, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('1403/5/15', APoint(172.13668673507195, 7.6274657833401225, 0.0), 2.0)
entity.Color = 1

entity = acad.model.AddText('k3', APoint(214.14010818091788, 18.81413230542546, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('title', APoint(214.22244369193868, 7.193443505081677, 0.0), 1.5)
entity.Color = 7

entity = acad.model.AddText('k2', APoint(256.76944855299257, 7.951570707954943, 0.0), 1.7)
entity.Color = 7

entity = acad.model.AddText('k1', APoint(256.9134080336812, 17.50061594009617, 0.0), 1.7)
entity.Color = 7
